...
<html lang="en">
  ...
  <head>
    ...
    <title>Smart Courier System</title>
  ...
  <body id="page-top">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
			 ...
			 <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="admin.php">Admin login</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="row h-100">
          <div class="col-lg-7 my-auto">
            <div class="header-content mx-auto">
              ...
              <a href="register.php" class="btn btn-outline btn-xl js-scroll-trigger reg_but">Proceed to Register</a>
            </div>
          </div>
    ...
    <section class="cta">
      <div class="cta-content">
        <div class="container">
          ...
          <a href="register.php" class="btn btn-outline btn-xl js-scroll-trigger reg_but">Let's Get Started!</a>
        </div>
      </div>
    ...
    <footer>
      <div class="container">
        <p>&copy; Smart Courier 2018. All Rights Reserved.</p>
